...
/**
 * Implementation of the `SearchIndexState` interface for storage in a MongoDB database. If SQL is desired,
 * please use `models.sql.SearchIndexStateSQL` instead.
 *
...
export class SearchIndexStateMongo extends BaseMongoEntity implements SearchIndexState {
    @Column()
    ...
    constructor(other?: Partial<SearchIndexStateMongo>) {
        super(other);
